...
public class MyLinkedList {
    ...
    public static void main(String[] args) {
        ...
        mll.append(4);
        mll.append(5);
        mll.reverseListRecursively(mll.head);
    }
     ...
     * Space Complexity: O(1)
     */
    private ListNode reverseListRecursively(ListNode currentNode){
        //base point
        if(currentNode == null || currentNode.next == null) return currentNode;
        
        //so we grab the next element (which will be the last after we reverse it)
        ListNode nextNode = currentNode.next;
        ListNode restLinkedListHead = reverseListRecursively(nextNode);
        //reverse
